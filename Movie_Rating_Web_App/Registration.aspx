<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="Movie_Rating_Web_App.Registration" %>
                ...
                <div class="card bg-dark text-white" style="opacity:0.9; border-radius: 20px;">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img width="150px" src="imgs/g_profile.png" />
                                </center>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">                                    
                                    <asp:TextBox CssClass="form-control rounded-pill" required="required" ID="TextBox1" runat="server" placeholder="Username" ></asp:TextBox>
                                </div>
                                ...
                                <div class="form-group">
                                    <asp:Button class="btn btn-success btn-block btn-lg rounded-pill" ID="Button3" runat="server" Text="Register" OnClick="Button3_Click"/>
                                    <hr />
                                </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <center>
                                            <h6 style="color: grey">Already Registered ?</h6>
                                        </center>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <a href="LoginForm.aspx">
                                        <input class="btn btn-primary btn-block btn-lg rounded-pill" id="Button4" type="button" value="Login" />                                           
                                    </a>
